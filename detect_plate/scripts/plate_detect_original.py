...
"""
    ...
    This program is to detect white rectangular plate and finding its center point (x, y).
    The HSV thresholds can be adjusted through trackbars.
...
class plate_detect:
    ...
    def image_callback(self,msg):
        ...
        cv2.createTrackbar("L-H", "Trackbars", 0, 180, self.image_callback)
        cv2.createTrackbar("L-S", "Trackbars", 0, 255, self.image_callback)
        cv2.createTrackbar("L-V", "Trackbars", 0, 255, self.image_callback)
        cv2.createTrackbar("U-H", "Trackbars", 255, 180, self.image_callback)
        cv2.createTrackbar("U-S", "Trackbars", 15, 255, self.image_callback)
        cv2.createTrackbar("U-V", "Trackbars", 255, 255, self.image_callback)
        ...
        #  biggest_contour = max(contour_sizes, key=lambda x: x[0])[1]
            ...
            for cnt in cnts:
                ...
                if area > 7500 and len(approx) == 4:
                    ...
                    cv2.circle(image, extLeft, 8, (0, 0, 255), -1)   #blue
                    cv2.circle(image, extRight, 8, (0, 255, 0), -1)  #green
                    cv2.circle(image, extTop, 8, (255, 0, 0), -1)    #red
